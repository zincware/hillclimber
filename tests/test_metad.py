...
def test_distance_cv_corresponding_strategy(small_ethnol_water):
    ...
    assert meta_d_model.to_plumed(small_ethnol_water) == [
        ...
        "metad: METAD ARG=d12_0,d12_1 HEIGHT=0.5 PACE=150 TEMP=300.0 FILE=HILLS ADAPTIVE=NONE BIASFACTOR=10.0 SIGMA=0.1,0.1 GRID_MIN=0.0,0.0 GRID_MAX=10.0,10.0 GRID_BIN=100,100",
